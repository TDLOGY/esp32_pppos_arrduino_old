/*
  PPPOSClientSecure.h - Base class that provides Client SSL to ESP32
...
#ifndef PPPOSClientSecure_h
#define PPPOSClientSecure_h
#include "Arduino.h"
#include "IPAddress.h"
#include "PPPOSClient.h"
#include "_ssl_client.h"

class PPPOSClientSecure : public PPPOSClient
{
protected:
    sslclient_context_t *sslclient;
